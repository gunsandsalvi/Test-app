...
**THE RUN TO JUDGE AGAINST IS THE NEXT ONE — §7.250's dead-channel revival relabelled the
world after the day's best reference (320/60, §7.250; before it §7.247's 351/60, §7.246's
361/67, §7.244's 628/94).** Each run is the record of its own tree; compare nothing across
them without naming the relabel between.
