...
| **THE UK INSTITUTIONAL BOOK IS AN EXPONENTIAL — §7.251's biggest new signal** | The UK non-MMF/non-ETF institutional book (cash + repo lent + itemized holdings) compounds **9→14%/week from ~w50: 692B → 2,236B in ten weeks** (15x flagged), with UK corpBondOwnership conservation failing beside it (7x, accounted 1.02→1.07 — the books hold MORE than the float, so a ledger is minting claims, not marking them) and USA joining late at 5–6%/wk. EUR/JPN sovereign books mint claims the same way (5x). UK is also the region whose capex prints 2.66x depreciation and whose household equity (5.45T) dwarfs its income — one overheating loop or one minting leg feeding all three. Next action: decompose ONE week's UK book delta by holding type (which instrument line grows, and whether a matching cash/issuance leg exists anywhere); the corpBondOwnership >1 print says start with corporate bonds. Owner: OWN/ETF2, with the measurement run. |
...
251. **THE REFERENCE RUN ON THE REVIVED-CHANNEL TREE: 367 violations in 60 families — THE RUN
     ...
     - **The new families the revival exposed** (none existed when the flows died in the
       channel): per-bank identity breaks, M-scale, w14 onward (~86 across 13 banks, CLFP 17x,
       IVQH 12x — a flow still missing a leg somewhere in the now-live post-08 writes);
       **USA NIM 41x, now with a story**: in band to w15, decays through 0.006 (w16) to
       NEGATIVE from w23, bottoming −0.033 by w31 — measured on real accretion income for the
       first time; USA capital ratio 14x follows it. **The UK institutional book compounds
       9→14%/week** (692B at w50 → 2,236B at w60, 15x flagged) with UK corpBondOwnership
       conservation failing alongside (7x, accounted 1.02→1.07) — an exponential on the books,
       not a mark; USA joins late at 5–6%/wk. MMF NAV departures in all regions (45x total,
       book > share liability by >2%). EUR/JPN sovereign books mint claims (5x, holdings over
       outstanding).
     - **Standing families that held**: JPN semiconductors supplier shares 24x (sum 45%,
       UNDER-supplied now, not over); UK/EUR government outlays over budget 39x (MAC's row);
       fund overdrafts (JPNEQX 34x, EURHYX 34x, scattered singles w1–5).
     ...
     - **The read that orders the queue**: the two biggest NEW signals — the M-scale identity
       drip and the UK institutional exponential — are both post-revival bank/book phenomena,
       and the NIM story is finally measurable. Work them in that order (identity legs feed NIM;
       the UK exponential is compounding toward a blowup past the horizon).
