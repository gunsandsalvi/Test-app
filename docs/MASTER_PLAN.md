...
STATUS (§7.304): stage 08's whole kernel lives in src/engine2/ (front pass over rows + back
kernel factory), bit-exact to the old tree; the RNG capture/resume contract makes split kernels
FP-safe; first hot-path pass landed on stage 05. Tests run at 4 weeks (user's cap, 2026-09-01);
week-4 timing 1,113 ms (05 382, 08 263, clearings 236).
