...
- **C3.b ✅** — *2026-09-05 (§9.27-iii-a):* `P2` holds every name's benchmark basis to the cheapest carry the relative-value book read to take it (`Region.cdsBasisCarryBpsByIssuer`); a survivor is a finding, one per name and tenor, no quota — at every tenor the book prints (§9.27-iv).
