...
const CLASS_WORDS: Record<string, string> = { IRS: 'interest-rate swap', CDS: 'credit default swap', COMMODITY_FUTURE: 'commodity future', FX_FORWARD: 'fx forward', OPTION: 'option' };
