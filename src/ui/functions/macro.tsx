...
import { dwellingUnitsOf } from '../../engine/ledger/dwelling-ledger';
  ...
  render({ world, ref, nav }) {
    ...
    return (<>
      ...
      <Card style={{ padding: '2px 0' }}>
        ...
        <KV k="home ownership" hint={sub('a read of the dwelling register')} v={pctLevel(ownershipRateOf(dwellingUnitsOf(ensureV2(world.state), r.id), r.totalPopulation), 0)} />
      </Card>
