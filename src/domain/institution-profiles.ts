...
export interface InstitutionProfile {
  ...
  /** Quotes CDS protection both ways (§3.17c): an unfunded long is exactly the trade a credit
   *  book wants, and buying it where the print is tighter than its own cost of the risk is the view. */
  readonly quotesCdsProtection: boolean;
