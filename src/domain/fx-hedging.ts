...
/**
 * Share of a cross-border position that gets hedged. Fixed income is hedged as a rule; equity
 * runs partial, which is what real mandates do (published policies cluster between none and half).
 */
