...
export function getInitialRegions(): Record<RegionId, Region> {
  ...
  return {
    USA: {
      ...
      name: 'United States',
      categoryDemand: {
        StapleHousehold: { demandLevelUSD: 0, demandGrowthAnnual: 0, demandHistory: [], crowdingIntensity: 0, inventoryLevelUSD: 0, inputCostPressure: 0 },
        StandardHousehold: { demandLevelUSD: 0, demandGrowthAnnual: 0, demandHistory: [], crowdingIntensity: 0, inventoryLevelUSD: 0, inputCostPressure: 0 },
        LuxuryHousehold: { demandLevelUSD: 0, demandGrowthAnnual: 0, demandHistory: [], crowdingIntensity: 0, inventoryLevelUSD: 0, inputCostPressure: 0 },
        CorporateIndustrial: { demandLevelUSD: 0, demandGrowthAnnual: 0, demandHistory: [], crowdingIntensity: 0, inventoryLevelUSD: 0, inputCostPressure: 0 },
        CorporateTech: { demandLevelUSD: 0, demandGrowthAnnual: 0, demandHistory: [], crowdingIntensity: 0, inventoryLevelUSD: 0, inputCostPressure: 0 },
        GovernmentDefense: { demandLevelUSD: 0, demandGrowthAnnual: 0, demandHistory: [], crowdingIntensity: 0, inventoryLevelUSD: 0, inputCostPressure: 0 },
        GovernmentInfrastructure: { demandLevelUSD: 0, demandGrowthAnnual: 0, demandHistory: [], crowdingIntensity: 0, inventoryLevelUSD: 0, inputCostPressure: 0 },
        GovernmentHealthcare: { demandLevelUSD: 0, demandGrowthAnnual: 0, demandHistory: [], crowdingIntensity: 0, inventoryLevelUSD: 0, inputCostPressure: 0 },
      },
      currency: 'USD',
      symbol: '$',
