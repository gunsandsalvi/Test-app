...
export function getInitialRegions(): Record<RegionId, Region> {
  ...
  return {
    USA: {
      ...
      corpBondOwnership: {
        bankShare: 0.27, institutionalShare: 0.32,
        foreignShare: { EUR: 0.09, UK: 0.05, JPN: 0.07, USA: 0 },
        centralBankShare: 0,
      },
      sovBondOwnership: {
        bankShare: 0.22, institutionalShare: 0.27,
        foreignShare: { EUR: 0.14, UK: 0.07, JPN: 0.10, USA: 0 },
        centralBankShare: 0.12,
      },
      institutionalSector: {
    ...
    UK: {
      ...
      corpBondOwnership: {
        bankShare: 0.26, institutionalShare: 0.32,
        foreignShare: { USA: 0.10, EUR: 0.07, JPN: 0.03, UK: 0 },
        centralBankShare: 0,
      },
      sovBondOwnership: {
        bankShare: 0.20, institutionalShare: 0.28,
        foreignShare: { USA: 0.14, EUR: 0.10, JPN: 0.04, UK: 0 },
    ...
    JPN: {
      ...
      corpBondOwnership: {
        bankShare: 0.32, institutionalShare: 0.32,
        foreignShare: { USA: 0.09, EUR: 0.05, UK: 0.02, JPN: 0 },
        centralBankShare: 0,
      },
      sovBondOwnership: {
        bankShare: 0.22, institutionalShare: 0.30,
        foreignShare: { USA: 0.07, EUR: 0.04, UK: 0.01, JPN: 0 },
        centralBankShare: 0.32,
      },
      institutionalSector: {
        corpBondHoldingsUSD: 0, sovBondHoldingsUSD: 0, equityHoldingsUSD: 0,
        cashUSD: 60_000_000_000, sectorEquityUSD: 75_000_000_000, investmentIncomeMarginPct: 0.018,
      },
    ...
    EUR: {
      ...
      corpBondOwnership: {
        bankShare: 0.28, institutionalShare: 0.30,
        foreignShare: { USA: 0.12, JPN: 0.04, UK: 0.02, EUR: 0 },
        centralBankShare: 0,
      },
      sovBondOwnership: {
        bankShare: 0.24, institutionalShare: 0.26,
        foreignShare: { USA: 0.18, JPN: 0.05, UK: 0.03, EUR: 0 },
        centralBankShare: 0.14,
      },
      institutionalSector: {
        corpBondHoldingsUSD: 0, sovBondHoldingsUSD: 0, equityHoldingsUSD: 0,
