...
export function createInitialContext(state: GameState): WeeklyStepContext {
  ...
  return {
    ...
    holderAccruedInterestUSD: state.holderAccruedInterestUSD ?? new Map<string, Map<string, number>>(),
    sovereignAccruedInterestUSD: state.sovereignAccruedInterestUSD ?? new Map<string, number>(),
