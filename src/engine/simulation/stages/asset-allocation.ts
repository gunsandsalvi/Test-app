 ...
 */
export function entityRequiredReturn(entity: InstitutionalEntity, totalAssetsLocal: number): number {
  ...
  return institutionProfile(entity.entityType).liabilityHurdle?.(entity, stated, totalAssetsLocal) ?? stated;
}
