...
export class CentralBankIdentityTrace {
  ...
  private residuals(ctx: WeeklyStepContext): Map<RegionId, number> {
    ...
    REGION_IDS.forEach((r) => {
      ...
      const tga = treasuryAccountOf(ctx.v2, r), assets = centralBankAssetsLocal(centralBankSovereignAssetsLocal(ctx.v2, r), cb, waysAndMeansOf(ctx.v2, r), currencyOf(r), ctx.fx);
