...
export function registerBook(v2: V2World, id: InstrumentId, kind: 'IRS' | 'CDS' | 'CDS_INDEX' | 'FX_SPOT' | 'XCS' | 'COMMODITY_FUTURE' | 'BOND_FUTURE' | 'REPO' | 'SBL' | 'OPTION' | 'INTERBANK', currency: CurrencyCode): InstrRef {
