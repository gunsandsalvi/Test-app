...
const NEVER_SOLD_HERE = [
  { subUnitId: 'household_essentials', demandLevelAnnualLocal: 36_870_000_000, measuredRevenueLocal: 0 },
  { subUnitId: 'food_beverage', demandLevelAnnualLocal: 40_200_000_000, measuredRevenueLocal: 9_823_568_693 },
];
...
test('a pool that has sold everywhere follows its own book, not the demand', () => {
  ...
  const soldEverywhere = [
    { subUnitId: 'a', demandLevelAnnualLocal: 100, measuredRevenueLocal: 90 },
    { subUnitId: 'b', demandLevelAnnualLocal: 100, measuredRevenueLocal: 10 },
  ];
...
test('a pool that has sold nowhere follows the demand entirely', () => {
  const soldNowhere = [
    { subUnitId: 'a', demandLevelAnnualLocal: 300, measuredRevenueLocal: 0 },
    { subUnitId: 'b', demandLevelAnnualLocal: 100, measuredRevenueLocal: 0 },
  ];
