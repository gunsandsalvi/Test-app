...
# Navigation Tab Bar
nav_start = text.find('<nav className="flex items-center justify-between gap-1 p-2 bg-slate-900 border-b border-slate-800 text-[10px]')
nav_end = text.find('</nav>', nav_start) + 6

new_nav = """        <nav className="flex items-center justify-between gap-1 p-2 bg-slate-900 border-b border-slate-800 text-[10px] font-bold uppercase tracking-wider shrink-0 overflow-x-auto no-scrollbar">
          <button
            id="nav-tab-macro"
