...
MUTATORS='(pushBookRow|relinkBook|newBookRow|freeBookRow|setBookChain|mutableHoldings|pruneEmptyRows|clearDirtyBooks|addAccrued|appendLot|adjustLots|moveLotsTo|openKindRow|recycleLots|setLien)'
